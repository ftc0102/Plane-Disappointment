class Game extends Phaser.Scene{
    ...
    create() {
        ...
        // Temp Player
        this.player = new Player(this, game.config.width/10, game.config.height/2, 'chefsprite').setOrigin(0, 0);
        this.player.anims.play('chef');      // plays the running animation
        this.player.setScale(.2);            // makes the player bigger
